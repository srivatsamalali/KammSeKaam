  ...
  return (
    <div className="flex flex-col items-center mb-2 animate-fade-in select-none">
        ...
        >
          ...
          {showPassword ? (
            <>
              ...
              {/* Pupil */}
              <circle cx="38" cy="46" r="3.5" fill="#333333" className="animate-pulse" />
              <circle cx="62" cy="46" r="3.5" fill="#333333" className="animate-pulse" />
            </>
          ) : (
            <>
              {/* Eyes Covered/Closed */}
      ...
      <span className="text-[10px] text-slate-400 font-semibold mt-1">
        {showPassword ? '🙈 Peek-a-boo!' : '🙉 Covered!'}
      </span>
    </div>
  )
}
